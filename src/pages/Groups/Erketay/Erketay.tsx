...
const images: Image[] = [
  { src: Tauelsizdik, alt: "Еркетай тобы" },
  { src: baksha, alt: "Еркетай тобы" },
  { src: baksha2, alt: "Еркетай тобы" },
  { src: baksha3, alt: "Еркетай тобы" },
];

const Erketay: React.FC = () => {
